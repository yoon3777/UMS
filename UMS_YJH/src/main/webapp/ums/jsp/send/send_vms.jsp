...
<div class="container-fluid" id="con">
	<div class="row pt-4">
		<div class="col-sm-3">
			...
			<div class="pt-4" style="height: 150px;">
				...
				<div style="height: 100px;">
					...
					<div id="vmradio">
						<label>
							<input type="radio" name="vmradio" id="vmradio1" value="0">
							남성
						</label>
						<label>
							<input type="radio" name="vmradio" id="vmradio2" value="1">
							여성
						</label>
					</div>
				</div>
		...
		<div class="col-sm-8 pt-4">
			<textarea class="form-control" id="textarea" placeholder="음성으로 변환하여 전송할 TEXT를 입력해주세요 (최대 1000Bytes)"></textarea>
			<div class="pt-1"></div>
